...
Quiz.create([
    ...
    { title: 'ITクイズ', image: '', user_id:2, description:"bbb" },
    { title: 'ITクイズ', image: '', user_id:3, description:"ccc" },
    { title: 'ITクイズ', image: '', user_id:3, description:"ddd" },
    { title: 'ITクイズ', image: '', user_id:4, description:"eee" } ,
])
Question.create([
